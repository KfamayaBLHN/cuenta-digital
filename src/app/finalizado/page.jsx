...
export default function Solicitar() {
  ...
  return (
    <>
      <Head>
        <title>Solicitud de Cuenta Digital recibida</title>
        <meta name="description" content="Cuenta Digital - Banco LAFISE - Honduras" />
        <meta name="robots" content="index"></meta>
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Solicitud de Cuenta Digital recibida" />
        <meta property="og:description" content="Cuenta Digital - Banco LAFISE - Honduras" />
        ...
        <link rel="canonical" href="https://www.lafise.com/blh/cuenta-digital/finalizado/" /> 
      </Head>
          ...
          <div className="row">
            <div className="col-12 py-5">
              <div className="layout-fullwidth text-center text-white">
                ...
                <a className="link tc-white mt-5 d-block textlink" href="https://www.lafise.com/blh/">Volver al sitio web</a>
              </div>
            </div>
          </div>
        </div>
